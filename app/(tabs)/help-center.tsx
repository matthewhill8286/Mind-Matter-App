  ...
  return (
    <View style={styles.page}>
      ...
      <View style={{ marginTop: 16, gap: 10 }}>
        <Pressable onPress={() => router.push("/(tabs)/profile")} style={styles.link}><Text style={styles.linkText}>Back to Profile</Text></Pressable>
        <Pressable onPress={() => router.push("/resources")} style={styles.link}><Text style={styles.linkText}>Resources</Text></Pressable>
      </View>
    </View>
  );
}
