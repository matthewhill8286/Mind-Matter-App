...
export default function Mood() {
  ...
  const insights = useMemo(() => {
    ...
    const avgMood = last.reduce((a, x) => a + moodToScore(x.mood ?? 'Okay'), 0) / last.length;
          ...
          <View style={{ marginTop: 12, gap: 12 }}>
            ...
            <View style={{ backgroundColor: colors.card, borderRadius: UI.radius.lg, padding: 14 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 8 }}>
                ...
                />
                <Text style={{ color: colors.mutedText, fontWeight: '600' }}>hrs</Text>
              </View>
